<?php
$pageTitle = $product && $product->id ? 'Edit Product' : 'Add Product';
...
<div class="bg-white rounded-xl shadow-sm p-6">
    <h1 class="text-2xl font-bold text-slate-800 mb-4"><?= $isEdit ? 'Edit Product' : 'Add Product' ?></h1>
    <form method="post" action="<?= $isEdit ? '/products/' . (int) $product->id . '/update' : '/products/create' ?>" id="product-form" class="space-y-4 max-w-md">
        <div>
...
<?php require $basePath . '/layout/footer.php'; ?>
