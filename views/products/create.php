...
<div class="bg-white rounded-xl shadow-sm p-6">
    <h1 class="text-2xl font-bold text-slate-800 mb-4">Register Product</h1>
    <form method="post" action="/products/create" id="product-form" class="space-y-4 max-w-md">
        <div>
        ...
        <div class="flex gap-2">
            <button type="submit" class="bg-amber-500 hover:bg-amber-600 text-white font-medium py-2 px-4 rounded-lg transition">Create Product</button>
